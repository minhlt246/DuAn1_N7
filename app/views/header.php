      ...
      <div class="offcanvas offcanvas-start" id="menu" tabindex="-1" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body align-items-center">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <a class="btn  me-md-2 btn-log" type="button" href="register.html">Đăng KÍ</a>
              <a class="btn  btn-reg" type="button" href="Login.html">ĐĂng Nhập</a>
          </div>
            <a class="text-black fs-4 align-items-center ms-3" type="button" href="cart.html">
