...
<header>
  <nav class="navbar navbar-expand-lg mx-lg-4">
    <div class="container-fluid"><a class="navbar-brand" href=""><img class="img-logo" src="../public/client/images/logo.png"/></a>
      ...
      <div class="offcanvas offcanvas-start" id="menu" tabindex="-1" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body align-items-center">
          <ul class="navbar-nav justify-content-center flex-grow-1 pe-3 align-items-center">
            ...
            <li class="nav-item mx-lg-2"><a class="nav-link" href="">Trang Chủ</a></li>
            <li class="nav-item mx-lg-2"><a class="nav-link" href="">Sản Phẩm</a></li>
            <li class="nav-item mx-lg-2"><a class="nav-link" href="">Tin tức</a></li>
            <li class="nav-item mx-lg-2"><a class="nav-link" href="">Giới thiệu</a></li>
            <li class="nav-item mx-lg-2"><a class="nav-link" href="">Liên Hệ</a></li>
          </ul>
          <div class="d-grid gap-2 d-md-flex justify-content-md-end"><a class="btn btn-primary me-md-2 btn-log" type="button" href="">Đăng KÍ</a><a class="btn btn-primary btn-reg" type="button" href="">ĐĂng Nhập</a></div><a class="text-black fs-4 align-items-center ms-3" type="button" href=""><i class="fa-solid fa-cart-shopping"></i></a>
        </div>
      </div>
    </div>
  </nav>
